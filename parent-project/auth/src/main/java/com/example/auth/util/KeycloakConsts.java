...
//    admin:
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(authServerUrl, that.authServerUrl) && Objects.equals(realm, that.realm) && Objects.equals(resource, that.resource) && Objects.equals(secret, that.secret) && Objects.equals(authServerUrlAdmin, that.authServerUrlAdmin) && Objects.equals(realmAdmin, that.realmAdmin) && Objects.equals(clientIdAdmin, that.clientIdAdmin) && Objects.equals(usernameAdmin, that.usernameAdmin) && Objects.equals(passwordAdmin, that.passwordAdmin);
    }

    @Override
    public int hashCode() {
        return Objects.hash(authServerUrl, realm, resource, secret, authServerUrlAdmin, realmAdmin, clientIdAdmin, usernameAdmin, passwordAdmin);
    }
}
